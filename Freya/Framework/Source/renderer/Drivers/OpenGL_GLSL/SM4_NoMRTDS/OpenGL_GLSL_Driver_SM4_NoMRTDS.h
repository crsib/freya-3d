...
#ifndef OPENGL_GLSL_DRIVER4MRTDS_H
#define OPENGL_GLSL_DRIVER4MRTDS_H
...
{
	friend class renderer::drivers::ids::OpenGL_GLSL_SM4_NOMRTDS;
protected:
	OpenGL_GLSL_Driver();
