...
function(gp_item_default_embedded_path item default_embedded_path_var)
  ...
  if(APPLE)
    ...
    #
    set(path "@executable_path/../../Contents/Libraries")
...
function(gp_resolved_file_type original_file file exepath dirs type_var)
  ...
  if(NOT is_embedded)
	...
	if(resolved_file MATCHES "libboost|libSDL|libicu" )
        	set(is_system 0)
	else()
		set(is_system 1)
	endif()
    ...
    if(APPLE)
     # MESSAGE( "Resolved file: ${resolved_file} " )
      if(resolved_file MATCHES "^(/System/Library/|/usr/lib/)")
      	if(resolved_file MATCHES "libboost|libSDL|libicu" )
      		#MESSAGE( "Resolved non system file: ${resolved_file} " )
        	set(is_system 0)
        else()
        	set(is_system 1)
        endif()
