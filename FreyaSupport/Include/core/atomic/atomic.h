...
#include "atomic-interface.h"
	...
	#include "details/atomic-clang.h"
		...
		#include "details/atomic-gcc-4.1.0+.h"
	#else
		//#if defined( i686 here )
			//atomic implementation for gcc elder then 4.1.0 for x86 based systems.
			#include "details/atomic-gcc-x86.h"
		//#elif defined ( ARMv7 here )
		//	//atomic implementation for gcc elder then 4.1.0 for ARMv7
		//	#include "details/atomic-gcc-arm.h"
		//#endif
	#endif
#elif defined(_MSC_VER) // Supported arch x86-64.
	#include "details/atomic-msvc.h"
#endif
