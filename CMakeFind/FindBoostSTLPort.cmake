...
IF(Boost_INCLUDE_DIR)
  ...
  if(Boost_VERSION AND BoostSTLPort_FIND_COMPONENTS)
     ...
     if(${_boost_maj}.${_boost_min} VERSION_LESS 1.35)
       list(REMOVE_ITEM BoostSTLPort_FIND_COMPONENTS system)
     endif()
  endif()

  FOREACH(COMPONENT ${BoostSTLPort_FIND_COMPONENTS})
...
ELSE (_boost_IN_CACHE)
  ...
  MESSAGE("Searching for components: ${BoostSTLPort_FIND_COMPONENTS}")
  FOREACH(COMPONENT ${BoostSTLPort_FIND_COMPONENTS})
    ...
    FIND_LIBRARY(Boost_${UPPERCOMPONENT}_LIBRARY_RELEASE
        NAMES  ${Boost_LIB_PREFIX}boost_${COMPONENT}${_boost_COMPILER}${_boost_MULTITHREADED}-p-${Boost_LIB_VERSION}
               ${Boost_LIB_PREFIX}boost_${COMPONENT}${_boost_COMPILER}${_boost_MULTITHREADED}${_boost_STATIC_TAG}-p-${Boost_LIB_VERSION}
               ${Boost_LIB_PREFIX}boost_${COMPONENT}${_boost_MULTITHREADED}-p-${Boost_LIB_VERSION}
               ${Boost_LIB_PREFIX}boost_${COMPONENT}${_boost_MULTITHREADED}${_boost_STATIC_TAG}-p-${Boost_LIB_VERSION}
               ${Boost_LIB_PREFIX}boost_${COMPONENT}${_boost_MULTITHREADED}-p
               ${Boost_LIB_PREFIX}boost_${COMPONENT}${_boost_MULTITHREADED}${_boost_STATIC_TAG}-p
               ${Boost_LIB_PREFIX}boost_${COMPONENT}-p
  ...
  IF(Boost_INCLUDE_DIR)
    ...
    if (_Boost_MISSING_COMPONENTS)
      ...
      list(LENGTH BoostSTLPort_FIND_COMPONENTS Boost_NUM_COMPONENTS_WANTED)
