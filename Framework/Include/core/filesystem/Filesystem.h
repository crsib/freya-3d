...
public:
	 ...
	 */
	virtual void mount(const EString& type, const EString& path = EString()) = 0;
	 ...
	 */
	virtual void makeDir(const  EString& path, int to = 0) = 0;
	 ...
	 */
	virtual void* read(const EString& path,int from = -1) = 0;
	 ...
	 * \return Address of memory block containing file (caller is responsible of future memory management)
	 */
	virtual void*  read(const EString& path, size_t* sz,int from = -1) = 0;
	//!Get file size
	/*!
	 ...
	 */
	virtual void write(const EString& path, const void* buf, size_t sz, int to = 0) = 0;
	 ...
	 */
	virtual void remove(const EString& path,int from = 0) = 0;
	 ...
	 */
	virtual int where(const EString& path,SearchMode mode = EVERYWHERE) = 0;
