...
#ifndef OPENGL_GLSL_DRIVER3MRTDS_H
#define OPENGL_GLSL_DRIVER3MRTDS_H
...
{
	friend class renderer::drivers::ids::OpenGL_GLSL_SM3_NOMRTDS;
protected:
	OpenGL_GLSL_Driver();
